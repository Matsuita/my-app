...
//	売上登録画面
	@GetMapping("/S0010")
	public String newSale(Integer accountId, Integer categoryId, Model model) {
		List<Account> accountList;
//		List<Categories> categoriesList;
		accountList = accountRepository.findByAccountId(accountId);
//		categories = categoriesRepository.findByCategoryId(categoryId);
...
//　売上登録確認画面
	@PostMapping("/S0011")
	public String salesConfirm(Sale sale, Model model) {
